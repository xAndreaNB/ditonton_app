...
import 'package:movies/data/models/movie_response_model.dart';
...
void main() {
  ...
  group('get Now Playing Movies', () {
    final tMovieList = MovieResponseModel.fromJson(
            json.decode(readJson('dummy_data/movies/now_playing_movies.json')))
        .movieList;
    ...
    test('should return list of Movie Model when the response code is 200',
      ...
      when(mockHttpClient
          ...
          .thenAnswer((_) async => http.Response(
              readJson('dummy_data/movies/now_playing_movies.json'), 200));
      // act
  ...
  group('get Popular Movies', () {
    final tMovieList = MovieResponseModel.fromJson(
            json.decode(readJson('dummy_data/movies/popular_movies.json')))
        .movieList;
    ...
    test('should return list of movies when response is success (200)',
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/popular?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/movies/popular_movies.json'), 200));
      // act
  ...
  group('get Top Rated Movies', () {
    final tMovieList = MovieResponseModel.fromJson(
            json.decode(readJson('dummy_data/movies/top_rated_movies.json')))
        .movieList;
    ...
    test('should return list of movies when response code is 200 ', () async {
      ...
      when(mockHttpClient.get(Uri.parse('$BASE_URL/movie/top_rated?$API_KEY')))
          .thenAnswer((_) async =>
              http.Response(readJson('dummy_data/movies/top_rated_movies.json'), 200));
      // act
  ...
  group('get movie recommendations', () {
    final tMovieList = MovieResponseModel.fromJson(json
  ...
  group('search movies', () {
    final tSearchResult = MovieResponseModel.fromJson(json
